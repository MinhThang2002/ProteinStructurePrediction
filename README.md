...
python main.py --mode pssms --train True \
    ...
    --h_dim 64 --integer_sequence False --num_workers 0 \
    --model_save_path './models'
```
> On macOS/Windows keep `--num_workers 0` to avoid a PyTorch pickling error in the SidechainNet collate function. On Linux you can increase it (e.g., 2–4) for faster loading.
...
python main.py --mode seqs --train True \
    ...
    --n_heads 8 -h_dim 64 --integer_sequence True --num_workers 0 \
    --model_save_path './models'
```
...
```
Inference saves:
- `./plots/{idx}_pred.pdb`, `./plots/{idx}_true.pdb`
- `./plots/{idx}_compare.html` with an embedded 3Dmol.js viewer (open in browser; requires internet to load 3Dmol.js CDN).
